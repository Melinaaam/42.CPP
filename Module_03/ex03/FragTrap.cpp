...
{
    std::cout << "___ FragTrap : Default Constructor called !" << std::endl;
    _HitPoints = 100;
    _EnergyPoints = 100;
    _AttackDamage = 30;
}
...
{
    std::cout << "___FragTrap Copy constructor of  " << copy._Name << " called !" << std::endl;
	*this = copy;
}
FragTrap::~FragTrap(void)
{
    std::cout << "___FragTrap Destructor called for " << _Name << " !" << std::endl;
}
