...
Dog::Dog(const Dog& copy) : Animal(copy)
{
	...
	// ce qui signifierait que deux objets Dog pointeraient vers le même Brain. 
	//Si l'un des objets est détruit, il va supprimer le Brain, laissant l'autre objet avec un pointeur invalide
}
